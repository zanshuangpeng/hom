          ...
          <table width="100%" class="am-table am-table-bordered am-table-radius am-table-striped">
            <thead>
              <tr class="am-success">
                ...
                <th class="table-author am-hide-sm-only">产品价格</th>
                <th class="table-date am-hide-sm-only">数量</th>
                <th width="130px" class="table-set">操作</th>
              </tr>
            </thead>
            <tbody>
              <c:forEach items="${ol}" var="l" varStatus="loop">
              <tr>
                <td><input type="checkbox" /></td>
                
                <td>${ot[loop.count-1].id}</td>
                <td><a href="#">${ot[loop.count-1].user_name}</a></td>
                <td>${ot[loop.count-1].address}</td>
                <td class="am-hide-sm-only">${l.p_name }</td>
                <td class="am-hide-sm-only">${l.price }</td>
                <td class="am-hide-sm-only">${l.number }</td>
                <td> 	
                	<div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                       <a href="UserDelete?id=${p.id}"><span class="am-icon-trash-o" ></span></a>
                    </div>
                  </div>
                </td>
              </tr>
