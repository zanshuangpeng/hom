		 ...
		 <div class="ctnt-bar cntnt">
				...
				$('#etalage').etalage({
					...
					click_callback: function(image_anchor, instance_id){
					 ...
					 <div class="details-left-info">
							<h3>${p.name}</h3>
								<h4>Model No: ${p.id}</h4>
							<p><label>$</label>${p.price}<a href="#">Click for offer</a></p>
							<p class="size">SIZE :</p>
							<a class="length" href="#">S</a>
							<div class="btn_form">
								<a href="cart.html?id=${p.id }">buy now</a>
								<a href="CartAdd?id=${p.id }&price=${p.price}&p_name=${p.name}">ADD TO CART</a>
							</div>
							<div class="bike-type">
		  ...
		  <div class="single-bottom2">
			 ...
			 <div class="product">
					 ...
					 <div class="product_price">
							<span class="price-access">$11</span>								
							<a class="button1" href="cart.html"><span>Add to cart</span></a>
					 </div>
				  <div class="clearfix"></div>
			 </div>
